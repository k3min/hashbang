...
void 0===a||null===a?a={status:this.xhr.status,message:this.xhr.statusText}:void 0===a.status&&(a.status=-1);"function"===typeof this.error&&this.error(a);this.debug&&console.error(a)}});void 0===f.HTMLDialogElement&&(f.HTMLDialogElement=HTMLElement.extend({returnValue:"",constructor:function(){console.error("Illegal constructor")},open:{get:function(){return this.hasAttribute("open")},set:function(a){a?this.setAttribute("open",""):this.removeAttribute("open")}},show:function(){this.open=!0},close:function(a){void 0!==
a&&(this.returnValue=a);this.dispatchEvent(new CustomEvent("close"));this.open=!1;this.returnValue=""}}),g.registerElement("dialog",{prototype:l(HTMLDialogElement.prototype)}));Node.prototype.replaceChildren=function(a){for(;this.firstChild;)this.removeChild(this.firstChild);this.appendChild(a)};String.prototype.format=function(a){var c=0;"object"!==typeof a&&(a=[].slice.call(arguments));return this.replace(/:([a-z]+)|\{([0-9])?\}/g,function(b,e,d){return a[e||d||c++]})};Date.prototype.format=function(a){var c=
Date.ordinals,b=Date.days,e=Date.months,d=this.getDate(),f=this.getDay(),g=this.getMonth(),k=this.getFullYear(),p=this.getHours(),h=p%12||12,l=this.getMinutes(),m=this.getSeconds(),n={d:10>d?"0"+d:d,D:b[f].substr(0,3),j:d,l:b[f],N:f||7,S:3<d&&20>=d?c[0]:c[d%10]||c[0],w:f,F:e[g],m:10>g?"0"+(g+1):g+1,M:e[g].substr(0,3),n:g+1,t:(new Date(k,g+1,0)).getDate(),Y:k,y:(""+k).substr(2,2),a:12>p?"am":"pm",A:12>p?"AM":"PM",g:h,G:p,h:10>h?"0"+h:h,H:10>p?"0"+p:p,i:10>l?"0"+l:l,s:10>m?"0"+m:m};return a.replace(/\\?([a-z])/gi,
function(a,b){return void 0!==n[a]?n[a]:b})};Date.ordinals=["th","st","nd","rd"];Date.days="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ");Date.months="January February March April May June July August September October November December".split(" ");void 0===k.dataset&&h(HTMLElement.prototype,"dataset",{get:function(){for(var a={},c=this.attributes,b=0;b<c.length;b++){var d=c[b].name.split("-");void 0!==d[1]&&"data"===d[0]&&(a[d[1]]=c[b].value)}return a}});t(7)&&(f.CustomEvent=
Event.extend({constructor:function(a,c){var b=g.createEvent("CustomEvent");b.initCustomEvent(a,!1,!1,c.detail);return b}}))})(this);
