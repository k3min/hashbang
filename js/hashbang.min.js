...
set:function(a){b=a;if("id"!==a){var c=1;"-"===a[0]&&(a=a.substring(1),c=-1);this.blocks.sort(function(b,g){b=b.reduce(a);g=g.reduce(a);return(b<g?-1:b>g?1:0)*c})}}});this.sortBy=this.template.element.dataset.sort||"id"};m.prototype.show=function(a){for(var b=c.collection=a?Object.create(this):this,d=this.title,n=this.template;c.root.firstChild;)c.root.removeChild(c.root.firstChild);if(a){b.blocks=this.search("handle",a);if(0===b.blocks.length)return k.hash="#!/{}".format(this.handle);d=b.blocks[0].title;
n=b.blocks[0].template}n.render(b).forEach(function(a){c.root.appendChild(a)});e.body.classList.remove(r);e.body.classList.add(r=n.type);e.title=c.title.spec.format(c.title.text,d)};m.prototype.search=function(a,b){return this.blocks.filter(function(d){return d.reduce(a)===b})};var r,q=c.Block=function(a){for(var b in a)this[b]=a[b];this.time=new Date(a.time);this.template=new f(a.type)};q.prototype.reduce=function(a){a=a.split(".");var b=this[a[0]];if(void 0!==a[1])for(var d=1;d<a.length;d++)b=b[a[d]];
return b};String.prototype.format=function(a){var b=0;"object"!==typeof a&&(a=[].slice.call(arguments));return this.replace(v,function(d,c,e){return a[c||e||b++]})};var v=/:(\w+)|\{([0-9])?\}/g;Date.prototype.format=function(a){var b=this.getDate(),d=this.getDay(),c=this.getMonth(),e=this.getFullYear(),g=this.getHours(),f=12<g?g-12:g,h=this.getMinutes(),k=this.getSeconds(),l={d:10>b?"0"+b:b,D:Date.days[d].substr(0,3),j:b,l:Date.days[d],N:d+1,S:3<b&&20>=b?Date.ordinals[0]:Date.ordinals[b%10]||Date.ordinals[0],
w:d,F:Date.months[c],m:10>c?"0"+(c+1):c+1,M:Date.months[c].substr(0,3),n:c+1,t:(new Date(e,c+1,0)).getDate(),Y:e,y:(""+e).substr(2,2),a:12>g?"am":"pm",A:12>g?"AM":"PM",g:f,G:g,h:10>f?"0"+f:f,H:10>g?"0"+g:g,i:10>h?"0"+h:h,s:10>k?"0"+k:k};return a.replace(w,function(a,b){return void 0!==l[a]?l[a]:b})};Date.ordinals=["th","st","nd","rd"];Date.days="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" ");Date.months="January February March April May June July August September October November December".split(" ");
