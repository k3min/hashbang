(function(c){var k=c.document,h=c.location,f=k.documentElement,b=c.HA={version:"0.0.4",endpoint:"api/",valid:/image\/(jpeg|png|svg\+xml)/,main:function(){b.request=new HB.Request(b.endpoint);b.request.get({success:b.sync,error:b.error});b.upload.init()},update:function(){var a=k.querySelector("textarea");null!==a&&a.addEventListener("keydown",b.keys,!1)},keys:function(a){var b=!1;switch(a.keyCode){case 83:if(a.metaKey||a.ctrlKey)b=new CustomEvent("change",{detail:this}),HB.root.dispatchEvent(b),b=
