...
500:{title:"Something went wrong on the server!"}}};b.Dialog=k.registerElement("ha-dialog",{prototype:Object.create(HTMLDialogElement.prototype,{attachedCallback:{value:function(){d.addEventListener("keydown",this.keys.bind(this),!1);this.addEventListener("close",this.callback,!1);this.addEventListener("click",this.click,!1)}},render:{value:function(a,c){if(void 0!==a.buttons){var e=b.message,l=Object.keys(e);void 0===c&&(c={});for(var f in l){var g=l[f];if(e[g].title===a.title){c.action=g;break}}a.title=
a.title.format(c);a.data=JSON.stringify(c).replace(/"/g,"\\'")}this.replaceChildren(d.message.render(a));this.show()}},callback:{value:function(){var a=this.returnValue.replace(/\'/g,'"');if(""!==a&&(a=JSON.parse(a),void 0!==a.action))switch(a.action){case "delete":b["delete"](a.type,a.id);break;case "error":h.reload(!0)}}},click:{value:function(a){a.target===this&&(this.close(),a.preventDefault())}},keys:{value:function(a){var c=!1;if(this.open){switch(a.keyCode){case b.KEY.ESC:this.close();c=!0;
break;case b.KEY.TAB:var e=a.target,d=a.shiftKey,f=this.querySelectorAll("button"),g=f[0],f=f[f.length-1],h=e===k.body;e!==f&&!h||d?(e===g||h)&&d&&(f.focus(),c=!0):(g.focus(),c=!0)}c&&a.preventDefault()}}}}),"extends":"dialog"});Object.defineProperty(Object.prototype,"has",{value:function(a){for(var b in this)if(a.handle===b&&a.title===this[b])return!0;return!1}})})(this);
